...
const features = [
  ...
  },
  {
    ...
    description:
      "Make data-driven decisions with real-time insights and reporting.",
  ...
  },
  {
    ...
    description:
      "Enterprise-grade encryption and security for your sensitive data.",
  ...
  },
  {
    ...
    description:
      "Automated support system with live chat and ticket management.",
...
const faqs = [
  {
    ...
    answer:
      "Propertilico offers a comprehensive suite of tools including automated rent collection, maintenance tracking, tenant screening, financial reporting, and AI-powered analytics. Our platform streamlines daily operations, reduces manual work, and provides real-time insights for better decision-making.",
  },
  {
    question: "Is Propertilico suitable for small property owners?",
    answer:
      "Yes! Propertilico is designed to scale with your needs. Whether you manage 5 units or 5,000, our flexible pricing and feature set adapt to your requirements. Small property owners particularly benefit from our automation tools and simplified workflows.",
  },
  {
    question: "How secure is my data with Propertilico?",
    answer:
      "We implement bank-level security measures including 256-bit encryption, two-factor authentication, and regular security audits. Our platform is SOC 2 Type II certified and compliant with all major data protection regulations.",
  },
  {
    question: "Can I try Propertilico before committing?",
    answer:
      "Absolutely! We offer a 14-day free trial with full access to all features. No credit card required. You'll also get a personalized onboarding session with our customer success team to ensure you get the most out of our platform.",
  },
];
...
const Home = () => {
  ...
  const structuredData = useMemo(
    () => ({
      ...
      description:
        "Advanced property management software with AI-powered analytics and automation tools",
      offers: {
        "@type": "Offer",
        price: "0",
        priceCurrency: "USD",
  ...
  return (
    <>
      <Helmet>
        <title>
          Propertilico | Smart Property Management Software for Modern Landlords
        </title>
        <meta
          name="description"
          content="Transform your property management with Propertilico's AI-powered platform. Automate tasks, get real-time insights, and boost ROI. Start free trial today!"
        />
        <meta
          name="keywords"
          content="property management software, real estate management, landlord software, tenant management, property analytics, automation tools"
        />
        ...
        <meta
          property="og:title"
          content="Propertilico - Smart Property Management Software"
        />
        <meta
          property="og:description"
          content="Transform your property management with AI-powered automation and analytics. Designed for modern landlords and property managers."
        />
        <meta
          property="og:image"
          content="https://www.propertilico.com/og-image.jpg"
        />
        ...
        <meta
          name="twitter:image"
          content="https://www.propertilico.com/twitter-card.jpg"
        />
      ...
      <main id="main-content">
        <section className={styles.heroSection} aria-labelledby="hero-title">
          <div className={styles.heroContainer}>
            <div className={styles.heroContent}>
              ...
              >
                Streamline operations, boost efficiency, and maximize returns
                ...
                <div className={styles.testimonialContent}>
                  ...
                  <div className={styles.testimonialText}>
                    ...
                    <div
                      ...
                      aria-label={`Rated ${testimonials[activeTestimonial].rating} out of 5 stars`}
                    >
        ...
        >
          <div className={styles.container}>
            <h2 id="statistics-title" className={styles.sectionTitle}>
          ...
          <div className={styles.container}>
            ...
            >
              ...
              <p className={styles.ctaDescription}>
                Join thousands of property managers who have already streamlined
                their operations.
              </p>
              <div className={styles.ctaButtonContainer}>
                ...
                <p className={styles.ctaNote}>
                  No credit card required • 14-day free trial • Full featured
                </p>
              </div>
            </motion.div>
          </div>
